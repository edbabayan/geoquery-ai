"""
Advanced retrieval models with auto-generated enhanced metadata
"""
...
# Load or generate enhanced metadata
...
retriever_advanced_v2_reranked = ContextualCompressionRetriever(
...
retriever_advanced_v2_no_rerank = EnsembleRetriever(
    retrievers=[bm25_retriever_advanced_k5, vector_retriever_advanced_k5], 
    weights=[0.6, 0.4]
)

# Export for evaluation
__all__ = ['retriever_advanced_v2_reranked', 'retriever_advanced_v2_no_rerank', 'ground_truth_renamed']